    ...
    <>
      <Stack direction={'row'} sx={{ justifyContent: 'flex-end' }}>
        <Stack direction={'row'}>
          ...
          {/* history */}
          <Link to={'/history'} className='btn fs-1 text-primary'><FaHistory /></Link>
          {/* edit */}

          <div><Edit /></div>
          {/* download */}
          <button className='btn fs-1 text-primary'><MdSimCardDownload /></button>

          {/* back */}
          <Link to={'/resume'} className='btn fs-1 text-primary'><IoHome /></Link>
        </Stack>
      </Stack>
